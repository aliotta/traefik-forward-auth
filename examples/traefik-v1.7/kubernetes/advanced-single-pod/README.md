...
This example uses [Global Authentication](https://github.com/aliotta/traefik-forward-auth/blob/master/README.md#global-authentication) to apply authentication for the entire `https` entrypoint.
